...
public class Unusual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTextview.setText("Strange and Unusual Accidents");
    ...
    private void initialize() {
        ...
        listViewAdapter = new CustomListViewAdapter(Unusual.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        for (int i=0; i<separated.length;i++) {
            ...
            Person person = new Person("Weird Accident "+(i+1) + "", separated[i],"");
            persons.add(person);
    ...
    public class FetchDescription extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Unusual.this,R.style.MyProgressDialogTheme);
        ...
        protected Void doInBackground(Void... params) {
            ...
            try{
                ...
                String Blank="";
                String Explanation="";
                String dizi[] = {"DATE: ","CARRIER: ","LOCATION: ","EXPLANATION: "};

                Document doc = Jsoup.connect("http://www.planecrashinfo.com/unusual.htm").get();
                title = doc.title();
    ...
    private class FetchImageLogo extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected Void doInBackground(Void... params) {
            String yemekURL = "http://www.planecrashinfo.com/unusual.htm";
