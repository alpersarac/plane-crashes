...
public class Recents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recentcrashes);
    ...
    private void initialize() {
        ...
        listViewAdapter = new CustomListViewAdapter(Recents.this,persons);
    ...
    private void fillArrayList(ArrayList<Person>persons){
        ...
        for (int i=2; i<separated.length-4;i++) {
            if (i==separated.length-1){

                unwanteddata=separated[separated.length-1];
                String[] separated2 = unwanteddata.split("MORE RECENT ACCIDENTS");
                separated[separated.length-1]=separated2[0];

            }

                Person person = new Person("Recent Crash  "+(i-1) + "", "Date" + separated[i],imagesURLs.get(i));
                persons.add(person);
    ...
    public class FetchDescription extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try{
                ...
                Document doc = Jsoup.connect("http://www.planecrashinfo.com").get();
                title = doc.title();
    ...
    private class FetchImageLogo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(Recents.this,R.style.MyProgressDialogTheme);
        ...
        @Override
        protected Void doInBackground(Void... params) {
            String yemekURL = "http://www.planecrashinfo.com";
